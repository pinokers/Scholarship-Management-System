...
const Pre_registration_DisqualifiedSchema = new mongoose.Schema({
...
module.exports = mongoose.model('Pre_registration_disqualified', Pre_registration_DisqualifiedSchema);
